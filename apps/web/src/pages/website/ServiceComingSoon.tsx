  ...
  return (
    <>
      ...
      <div className="min-h-[65vh] flex flex-col justify-center items-center px-4 py-6 md:py-10 relative overflow-hidden font-sans">
        {/* Ambient Glows */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-purple-500/10 blur-[100px] rounded-full pointer-events-none" />
            ...
            <div className="pt-4 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3">
              <div className="flex flex-wrap items-center gap-2.5 w-full sm:w-auto">
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2 rounded-lg bg-primary hover:bg-[#6d28d9] text-white font-bold text-xs shadow-md shadow-purple-500/20 border border-white/10 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-1.5"
                >
